...
class DecoderLayer(nn.Module):
    ...
    def forward(self, tgt: torch.Tensor, encoder_output: torch.Tensor, tgt_mask: torch.Tensor, src_mask: torch.Tensor) -> torch.Tensor:
...
class EncoderDecoderTransformer(nn.Module):
    ...
    """
    def __init__(self, vocab_size: int, d_model: int, num_layers: int, num_heads: int, d_ff: int, dropout: float, pad_idx: int):
        super().__init__()
    ...
    def decode(self, tgt: torch.Tensor, encoder_output: torch.Tensor, tgt_mask: torch.Tensor, src_mask: torch.Tensor) -> torch.Tensor:
